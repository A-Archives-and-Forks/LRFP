...
Since KernelSU and its variants do not mount system partitions themselves, users need to install meta-modules to support rooting-level system modules that require system partition mounting. 
Therefore, compared with other rooting solutions, meta-modules are a unique feature of KernelSU and its variants. 

There are many meta-modules designed to provide system partition mounting support for rooting-level system modules, with the following three being the main examples. 
...
- [Hybrid Mount](https://github.com/Hybrid-Mount/meta-hybrid_mount/actions): This  meta module works in the hybrid mount mode, but is considered unstable and power-consuming. 

...
- Please install the build artifact generated by the latest workflow run in the GitHub Actions of [TEESimulator](https://github.com/JingMatrix/TEESimulator/actions) that was triggered by a push event and whose triggering actor is not a bot account
...
| OxygenOS 11 / PixelOS 16 | TEESimulator 4.x | Any configuration | No obvious abnormalities observed |  |
...
- 请安装 [TEESimulator](https://github.com/JingMatrix/TEESimulator/actions) 的 GitHub Actions 中的由 push 事件触发且触发者不为机器人的最新工作流所生成的构建
...
| OxygenOS 11 / PixelOS 16 | TEESimulator 4.x | 任意配置 | 未见有明显异常 |
